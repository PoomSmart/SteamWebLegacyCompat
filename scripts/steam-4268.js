...
****/
(self.webpackChunkstore = self.webpackChunkstore || []).push([[4268], {
    63292: e => {
        e.exports = {
    ...
    94057: (e, t, n) => {
        ...
        class g {
            ...
            {
                return this.m_mapNextDrawChangeCallback.has(e) || this.m_mapNextDrawChangeCallback.set(e, new u.lu), this.m_mapNextDrawChangeCallback.get(e)
            }
            CopyToGiveaway(e, t)
            {
                ...
                t.winner_count != e.winner_count && (t.winner_count = e.winner_count),
                t.seconds_until_drawing != e.seconds_until_drawing && (t.seconds_until_drawing = e.seconds_until_drawing)
            }
            async ReloadGiveaway(e, t)
            {
                ...
                return a = await o().get(n, {
                    params: r
                }), (0, l.h5)((() => {
                    if (this.m_mapGiveawayIDToNextDrawInfo.has(e) || this.m_mapGiveawayIDToNextDrawInfo.set(e, new p), this.CopyToGiveaway(a.data, this.m_mapGiveawayIDToNextDrawInfo.get(e)), void 0 !== t) {
                        const n = this.GetKey(e, t);
                        this.m_mapGiveawayIDAndInstanceToNextDrawInfo.has(n) || this.m_mapGiveawayIDAndInstanceToNextDrawInfo.set(n, new p),
                        this.CopyToGiveaway(a.data, this.m_mapGiveawayIDAndInstanceToNextDrawInfo.get(n))
                    }
                })), this.GetNextDrawChangeCallback(e).Dispatch(this.m_mapGiveawayIDToNextDrawInfo.get(e)), this.m_mapGiveawayIDToNextDrawInfo.get(e)
            }
            static s_Singleton;
            static Get()
            {
                return g.s_Singleton || (g.s_Singleton = new g, g.s_Singleton.Init(), "dev" == m.TS.WEB_UNIVERSE && (window.g_GiveawayStore = g.s_Singleton)), g.s_Singleton
            }
            Init()
            {
        ...
        function h(e) {
            const [t] = (0, i.useState)(new _),
                n = (0, d.CH)();
            (0, i.useEffect)((() => (g.Get().ReloadGiveaway(e, t.m_myInstanceNumber).then((a => {
                t.SetupRefreshDataInterval(a, (() => function(e, t) {
                    const n = g.Get().GetInfoByInstance(e, t.m_myInstanceNumber);
                    n && n.BIsValid() && n.seconds_until_drawing <= 0 && !n.closed && (t.ClearCountDown(), g.Get().ReloadGiveaway(e, t.m_myInstanceNumber).then((n => {
            ...
            const a = g.Get().GetInfoByInstance(e, t.m_myInstanceNumber),
                [r, o, l] = (0, s.q3)((() => [a?.winner_count,a?.closed,a?.seconds_until_drawing]));
            return {
                bLoadingGiveawayInfo: !a || null == a.giveaway_id || !a.BStarted() || void 0 === r,
                winner_count: r,
                closed: o,
    ...
    94743: (e, t, n) => {
        ...
        const d = e => {
                ...
                {
                    const r = "https://img.youtube.com/vi/" + e.video + "/" + t[n] + ".jpg",
                        i = () => {
                            n + 1 < t.length && o(n + 1)
                        },
                        c = () => {
            ...
            m = e => {
                    ...
                    });
                {
                    ...
                    return a.createElement("div", {
                        className: (0, s.A)("YoutubePreviewContainer", u().YoutubePreviewImage, e.imageClassnames),
                        onClick: t
                    }, a.createElement(d, {
                    ...
                    }, a.createElement(o.IOc, null)), a.createElement("div", {
    ...
    81881: (e, t, n) => {
        ...
        class _ {
            ...
            async LoadCounts()
            {
                return Boolean(this.m_counts) ? this.m_counts : (this.m_promise || (this.m_promise = this.LoadInternalCount()), this.m_promise)
            }
            async LoadInternalCount()
            {
                let e = null;
                try {
                    const t = u.TS.STORE_BASE_URL + "saleaction/ajaxgetuserdeckcompatcounts",
                        n = await p().get(t, {});
                ...
                return console.error("CDeckCompCountStore.LoadInternalCount failed: "+e?.strErrorMsg, e), null
            }
            static s_globalSingletonStore;
            static Get()
            {
                return _.s_globalSingletonStore || (_.s_globalSingletonStore = new _, "dev" != u.TS.WEB_UNIVERSE && "beta" != u.TS.WEB_UNIVERSE || (window.g_DeckCompatCountStores = _.s_globalSingletonStore)), _.s_globalSingletonStore
            }
            constructor()
            {
            ...
            {
                const t = e;
                return t && "number" == typeof t.verified && "number" == typeof t.unsupported && "number" == typeof t.playable
            }
        }
        var v = n(85320),
            h = n(56631),
        ...
        function y(e) {
            const {giveawayid: t} = e,
                n = (0, f.w)(t),
                {bLoadingGiveawayInfo: a, winner_count: o, closed: l, seconds_until_drawing: s} = n;
            return a ? null : r.createElement("div", {
                className: I.countdownCtn
            }, Boolean(l) && r.createElement("div", {
                className: I.Closed
            }, o > 0 ? (0, c.we)("#Giveaway_Closed", o.toLocaleString()) : (0, c.we)("#Giveaway_Closed_NoWinnerInfo")), Boolean(!l) && r.createElement(r.Fragment, null, Boolean(s <= 0) ? r.createElement("div", {
                className: I.Throbber
            }, r.createElement(S.t, {
                size: "small"
            }), r.createElement("div", null, (0, c.we)("#Giveaway_RandomDraw"))) : r.createElement("div", {
                className: I.CountDownCtn
            }, r.createElement("div", {
                className: I.CountDownTime
            }, b(Math.floor(s / 60)) + ":" + b(s % 60)), r.createElement("div", {
                className: I.CountDownText
            }, (0, c.we)("#Giveaway_CountDown2"), " ", (0, c.we)("#Giveaway_KeepWatching"))), Boolean(o > 0) && r.createElement("div", {
                className: I.WinnerInfo
            }, r.createElement("div", {
                className: I.WinnerCount
            }, o.toLocaleString()), r.createElement("div", {
        ...
        function P(e) {
            const {eventModel: t, nBadgeLevel: n, nMaxLevel: a} = e,
                ...
                {storePageFilter: l, eStoreDiscoveryQueueType: s} = r.useMemo((() => (0, F.lx)(t, o)), [t, o]),
                i = (0, H.Uf)(s, l),
                c = Math.min(n + i, a);
            return r.createElement("span", {
                className: "DisplayBadgeProgress"
        ...
        function U(e) {
            ...
            return u.iA.logged_in && n ? r.createElement(O, {
                nEventBadgeID: n,
                eventModel: t
            }) : null
        }
        function V(e) {
            ...
            return r.createElement(G.$n, {
                disabled: a,
                onClick: e => {
                    l || (u.iA.logged_in ? (s(!0), o(t, !0, null, !1).then((e => {
                        e || d(!0),
                        s(!1)
                    })).catch((() => {
                        d(!0),
            ...
            }, Boolean(i) ? r.createElement("div", null, (0, c.we)("#GrantAwardError_Busy")) : r.createElement(r.Fragment, null, Boolean(l) && r.createElement(S.t, {
                size: "small"
            }), Boolean(a) && r.createElement(D.Jlk, null), n))
        }
        function W(e) {
            const t = Number.parseInt((0, d.j$)(e.args)) || 0;
            return t >= 0 && t < 32 ? r.createElement(V, {
                nDoorIndex: t
            }, e.children) : null
        }
        const q = (0, B.y)(R.H);
        function Y(e) {
            ...
            if (t) {
                const o=n?.jsondata?.sale_sections?.findIndex((e => e.unique_id == t));
                if (o >= 0) {
                    const t = n.GetDayIndexFromEventStart();
                    return r.createElement(M.Cs, {
                        location: a ? 2 : 0
                    }, r.createElement(q, {
                        event: n,
                        ...
                        ePreviewMode: a ? x.S.EPreviewMode_Enabled : x.S.EPreviewMode_Disabled
                    }))
                }
                if (a)
                    return r.createElement("div", {
                        className: A.ErrorDiv
                    }, "Error could not find sale section ", t)
            }
            return null
        }
        var K = n(84811),
        ...
        const Q = r.Fragment;
        function Z(e) {
            const {reservationPackageID: t, event: n, depositPackageID: a, bIsPreview: o, psuLessPackageID: l, strOutOfStockOverride: s, strDeliveryOverride: i, bDeliveryOverrideOnlyIfOutOfStock: u} = e,
                d = (0, z.DR)(t),
                m = (0, z.DR)(l),
                p = (0, r.useMemo)((() => [{
                    ...
                    localized_out_of_stock_override: (0, X.$Y)([s || null], 31, null),
                    localized_delivery_override_desc: (0, X.$Y)([i || null], 31, null),
            ...
            return r.createElement(K.tH, null, r.createElement(r.Suspense, {
                fallback: null
            }, r.createElement(Q, {
                bIsPreview: o,
                rgReservationDef: p
            })), Boolean(d.allow_purchase_in_country) && r.createElement("div", {
                className: p[0].unique_id
            }, r.createElement(j.bk, {
                reservationDef: p[0],
                hardwareDetail: d,
                bPSULessModel: !1
            }), g && r.createElement(j.pc, {
                event: n,
                reservationDef: p[0],
                hardwareDetail: d
            }), Boolean(m?.allow_purchase_in_country) && r.createElement(j.bk, {
                reservationDef: p[0],
                hardwareDetail: m,
                bPSULessModel: !0
            })))
        ...
        function ie(e) {
            ...
            return (0, h.gS)(n, a) ? r.createElement(C.f, {
                language: e.language,
        ...
        function de(e) {
            const t = Number.parseInt((0, d.j$)(e.args)),
                n = "hide" in e.args && Boolean(Number.parseInt((0, d.j$)(e.args, "hide")));
            return t >= 0 ? r.createElement(me, {
                nDoorIndex: t,
                bHide: n
            }, e.children) : null
        }
        function me(e) {
            const {nDoorIndex: t, bHide: n, children: a} = e,
                o = (0, E.OM)(t);
            return null == o ? null : o && !n || !o && n ? r.createElement(r.Fragment, null, e.children) : null
        }
        function pe(e) {
            if (u.iA.logged_in) {
                const t = Number.parseInt((0, d.j$)(e.args)),
                    n = Number.parseInt((0, d.j$)(e.args, "mod"));
                if (n > 0 && t < n && u.iA.accountid % n == t)
                    return e.children
            }
            return null
        }
        function ge(e) {
            ...
            return t?.trim().length > 0 ? r.createElement("div", {
                className: t.trim()
            }, e.children) : r.createElement(r.Fragment, null, e.children)
        }
        function _e(e) {
            return r.createElement("span", {
                className: w.LocalizeBlock
            }, (0, c.oW)(e.children, r.createElement("b", null), r.createElement("b", null), r.createElement("b", null), r.createElement("b", null)))
        }
        function ve(e) {
            let t = (0, d.j$)(e.args);
        ...
        function Ce(e) {
            ...
            return r.useEffect((() => {
                ...
                i.O3.Init(),
                t && Ee.f.AddDictionary((null == se && (se = new Map([["itemdef", {
                    Constructor: ie,
                    autocloses: !1,
    ...
    86252: (e, t, n) => {
        ...
        const H = g.$.Get();
        function M() {
            document.body.classList.contains("events_hub") && document.body.classList.remove("events_hub")
        }
        const R = (0, u.PA)((e => {
                const {bInfiniteScroll: t, event_gid: n, announcement_gid: a, clansteamid: o, appid: l} = e,
                    ...
                    [g, w] = (0, r.useState)(!1),
                    I = (e, t) => {
                        t.token.reason || (i(e), function(e) {
                            let t;
                            if (e && e.appid)
                                t=L.A.Get().GetApp(e.appid)?.GetName();
                            else if (e && e.clanSteamID) {
                                const n = p.ac.GetClanInfoByClanAccountID(e.clanSteamID.GetAccountID());
                                t = n && n.group_name
                            }
                            const n = e && e.GetNameWithFallback((0, d.sf)(D.TS.LANGUAGE));
                            if (e && t && n) {
                                const e = (0, T.we)("#EventCalendar_TabTitle_GroupNameAndEventDetail", t, n);
                ...
                if ((0, r.useEffect)(M, []), (0, r.useEffect)((() => {
                    const e = c().CancelToken.source();
                    return s || (n && !H.GetClanEventModel(n) ? H.LoadPartnerEventGeneric(o, l, n, void 0, 0).then((t => I(t, e))).catch((() => {
                        e.token.reason || H.LoadPartnerEventGeneric(o, l, void 0, n, 0).then((t => I(t, e))).catch(k)
                    })) : a && !H.GetClanEventGIDFromAnnouncementGID(a) && H.LoadPartnerEventGeneric(o, l, void 0, a, 0).then((t => I(t, e))).catch(k)), () => {
                        e.cancel("StoreEventDetailView: unmounting")
                    }
                }), [n, o, l, a, s]), g || !s || s?.appid && !u) {
                    const e = "lang_" + (0, d.ww)((0, d.sf)(D.TS.LANGUAGE)),
                        t = "";
                    return r.createElement("div", {
                        className: (0, N.A)(f().EventDetailsPageContainer, e, b().PartnerEventFont, f().NoTitleArtwork)
                    }, r.createElement("div", {
                        style: {
                            height: "100px"
                        }
                    }), r.createElement(S.K8, {
                        strImageURL: t
                    }), r.createElement(S.P2, {
                        strImageURL: t,
                        body: g ? r.createElement("div", {
                            className: B().ErrorMsg
                        }, (0, T.PP)("#Events_FailedToFind", r.createElement("a", {
                            href: D.TS.STORE_BASE_URL + "news/"
                        }, (0, T.we)("#EventDisplay_NewsHubSubtitle")))) : r.createElement(y.t, {
                            string: (0, T.we)("#Loading"),
                            size: "medium",
                            position: "center"
                        }),
                        postbody: Boolean(g && o) ? r.createElement(C.rN, {
                            clanAccountID: o.GetAccountID(),
                            partnerEventStore: H
                        }) : void 0
                    }))
                }
                return t ? r.createElement(_.tH, null, r.createElement(h.N, {
                    appid: s.appid,
                    trackingLocation: 7,
                    ...
                    eventModel: s,
                    showAppHeader: !0,
                    closeModal: () => e.history.push((0, E.qT)(s, E.PH.k_eStoreNewsHub, "allowRelative"))
                })) : r.createElement(_.tH, null, r.createElement(S.jA, {
                    lang: (0, d.sf)(D.TS.LANGUAGE),
                    partnerEventStore: H,
                    event: s,
                    adminPanel: D.TS.EREALM === m.TU.k_ESteamRealmChina ? r.createElement(A.P, {
                        eventModel: s
                    }) : r.createElement(v.g, {
                        eventModel: s,
                        partnerEventStore: H
        ...
        class ue {
            ...
            static Get()
            {
                return ue.s_newsCuratorStore || (ue.s_newsCuratorStore = new ue, ue.s_newsCuratorStore.m_LoadingPromise = ue.s_newsCuratorStore.Init(), window.g_NewsCuratorStore = ue.s_newsCuratorStore), ue.s_newsCuratorStore
            }
            constructor()
            {
                (0, P.Gn)(this)
            ...
            async Init()
            {
                T.A0.GetLanguageListForRealms([D.TS.EREALM]).forEach((e => this.m_mapLangToNewsCurators.set(e, [])));
            ...
            {
                if (e.groupvanityinfo && p.ac.RegisterClanData(e.groupvanityinfo), e.newscuratorinfo)
                    for (const t of e.newscuratorinfo) {
                        if (this.m_mapNewsCurators.has(t.clanAccountID))
                            continue;
        ...
        function _e(e) {
            const t = new Set;
            return (e.indexOf("games") >= 0 || e.indexOf("dlc") >= 0) && t.add("apps"), e.indexOf("curators") >= 0 && t.add("curators"), t
        }
        class ve extends r.Component {
            ...
            m_mapHighestReceivedRequestIDFromBackEnd = new Map([["apps", 0], ["curators", 0]]);
            ...
            async GetCuratorSuggestions(e)
            {
                ...
                for (const a of t) {
                    ...
                    if ((t?.group_name?.toLocaleLowerCase() || "").indexOf(e) >= 0) {
                        if (this.props.fnFilterSuggestion && !this.props.fnFilterSuggestion(o))
                            continue;
                        if (ce.Fm.Get().BIsIgnoringCurator(t.clanAccountID))
                            continue;
                        ...
                        n.push(this.props.fnDecorateSuggestion ? this.props.fnDecorateSuggestion(o, a) : a)
                    }
                }
                this.m_mapHighestReceivedRequestIDFromBackEnd.set("curators", this.m_nHighestSentRequestID),
                this.setState({
                    rgCuratorSuggestions: n
                })
            }
            async GetAppSuggestionsFromServer(e)
            {
                const t = this.m_nHighestSentRequestID,
                    n = [];
                this.props.rgCorporaToSearch.indexOf("games") >= 0 && (n.push("game"), n.push("software")),
                this.props.rgCorporaToSearch.indexOf("dlc") >= 0 && (n.push("dlc"), n.push("music"));
                const a = {
                        cc: D.TS.COUNTRY,
                        l: D.TS.LANGUAGE,
                        ...
                        excluded_content_descriptors: ce.Fm.Get().ExcludedContentDescriptor
                    },
                ...
                l?.data?.length && (s = l.data.map((e => {
                    const t = {
                        corpus: (n = e.type, "game" == n || "software" == n ? "games" : "dlc" == n || "music" == n ? "dlc" : null),
                        ...e,
                        id: parseInt(e.id)
                    };
                    var n;
                    if (this.props.fnFilterSuggestion && !this.props.fnFilterSuggestion(t))
                        return null;
                    ...
                    return this.props.fnDecorateSuggestion ? this.props.fnDecorateSuggestion(t, a) : a
                }))),
                this.setState({
                    rgAppSuggestions: s
                })
            ...
            async UpdateSuggestions(e)
            {
                ...
                if (this.m_nHighestSentRequestID++, !t?.length)
                    return Array.from(_e(this.props.rgCorporaToSearch)).forEach((e => this.m_mapHighestReceivedRequestIDFromBackEnd.set(e, this.m_nHighestSentRequestID))), this.m_timerForChange.Cancel(), this.setState({
                        strSearchString: ""
                    }), void this.ResetSuggestions();
                this.setState({
                    strSearchString: t
                }),
                this.m_timerForChange.Schedule(300, (() => this.GetSuggestionsFromServer(t)))
            }
            ResetSuggestions()
            {
                this.setState({
            ...
            GetLimitedSuggestions()
            {
                ...
                let n = e ? e.length : 10,
                    a = t ? t.length : 10;
                return n + a > 10 && (n = 10 - Math.min(a, 2)), a = 10 - n, e=e?.slice(0, n), t=t?.slice(0, a), {
                    rgAppSuggestions: e,
                    rgCuratorSuggestions: t
                }
            }
            render()
            {
                const {strLabel: e, focusOnMount: t, rgCorporaToSearch: n, strResultsClass: a} = this.props,
                    {strSearchString: o} = this.state,
                    {rgAppSuggestions: l, rgCuratorSuggestions: s} = this.GetLimitedSuggestions(),
                    i = o?.length > 0,
                    c = l?.length > 0,
                    u = s?.length > 0,
                    d = _e(n).size > 1,
                    m = d && c && (0, T.we)(n.indexOf("dlc") >= 0 ? "#EventCalendar_SearchResultsHeader_GameAndDLCSection" : "#EventCalendar_SearchResultsHeader_GameSection"),
                    p = Array.from(_e(n)).some((e => this.m_nHighestSentRequestID > this.m_mapHighestReceivedRequestIDFromBackEnd.get(e))),
                    g = !u && !c && !p;
                return r.createElement("div", {
                ...
                }, m), l), u && r.createElement("div", {
                    key: "curator-suggestions"
                }, d && r.createElement("div", {
                    className: ge().ResultSectionHeader
                }, (0, T.we)("#EventCalendar_SearchResultsHeader_CuratorSection")), s), g && r.createElement("div", {
                    className: ge().EmptyResults,
                    key: "empty-results"
                }, (0, T.we)("#EventCalendar_GameSearch_NoneFound")), p && r.createElement(y.t, {
                    size: "small"
                })))
            }
        }
        (0, O.Cg)([se.oI], ve.prototype, "UpdateSuggestions", null);
        const he = e => r.createElement("div", {
        ...
        }, " ", (0, me.EK)(e.suggestion.name), " "), e.bShowFollowingLabel && r.createElement("div", {
            className: ge().Label
        ...
        var Ee = n(51706),
            ...
            we = n(63292),
            fe = n.n(we);
        const Ie = e => r.createElement(Ee.x_, {
                onEscKeypress: e.closeModal
            }, r.createElement(_.tH, null, r.createElement(te.UC, null, r.createElement(te.Y9, null, (0, T.we)("#EventCurator_BrowseDialog_Title")), r.createElement(te.nB, null, r.createElement("div", null, (0, T.we)("#EventCurator_BrowseDialog_Desc")), r.createElement(ye, null)), r.createElement(te.wi, null, r.createElement(te.jn, {
                onClick: e.closeModal
            }, (0, T.we)("#Button_Dismiss")))))),
            be = e => r.createElement($e, {
            ...
            ye = e => {
                ...
                r.useEffect((() => {
                    if (!t) {
                        (async () => {
                            await ue.Get().WaitForInitialLoad(),
                            n(!0)
                        })()
                    }
                }), [t]);
                let a = new Array;
                if (t) {
                    T.pf.GetELanguageFallbackOrder([m.TU.k_ESteamRealmGlobal]).forEach((e => a.push(r.createElement(Ne, {
                        key: "curlang" + e,
                        lang: e
                    }))))
                }
                return r.createElement(r.Fragment, null, t ? r.createElement(r.Fragment, null, a) : r.createElement(y.t, {
                    size: "medium",
                    position: "center",
                    string: (0, T.we)("#Loading")
                }))
            ...
            Ne = e => {
                ...
                if (!t)
                    return null;
                const n = t.map((e => p.ac.GetClanInfoByClanAccountID(e.clanAccountID))).filter((e => Boolean(e)));
                if (0 == n.length)
                    return null;
                n.sort(((e, t) => e.group_name.localeCompare(t.group_name)));
                const a = n.map((e => r.createElement(Ge, {
                    clanInfo: e,
                ...
                }, (0, T.we)("#EventCurator_BrowseDialog_LangCurator", (0, T.we)("#Language_" + (0, d.Lg)(e.lang)))), a)
            },
            Te = (0, u.PA)((e => {
            ...
            Ge = e => {
                const [t, n] = r.useState(!1),
                    ...
                    i = r.createElement(Te, {
                        ...
                        className: (0, N.A)(b().FlexRowContainer, fe().CuratorInfoTitleCtn),
                        onClick: () => n(!0)
                    }, r.createElement("img", {
                ...
                return r.createElement("div", {
                ...
                }, t ? r.createElement(_.tH, null, r.createElement(h.N, {
                    onEventNotFound: a,
                    appid: 0,
                    ...
                    className: (0, N.A)(b().FlexRowContainer, fe().CuratorInfoActionCtn)
        ...
        class Le {
            ...
            {
                return (!e.startVisible || e.startVisible <= this.m_dateLoadTime) && (!e.endVisible || e.endVisible >= this.m_dateLoadTime)
            }
            static IsCurrentlyActive(e)
            {
                const t = J.HD.GetTimeNowWithOverrideAsDate();
                return (!e.startEvent || e.startEvent <= t) && (!e.endEvent || e.endEvent >= t)
            }
            static LocalizeDateString(e)
            {
                if (!e.startEvent)
                    return null;
                const t = e.startEvent.toLocaleDateString(T.pf.GetPreferredLocales(), {
                    month: "long",
                    day: "numeric"
                });
                if (!e.endEvent)
                    return t;
                const n = {
                    month: e.startEvent.getMonth() != e.endEvent.getMonth() ? "long" : void 0,
                    day: "numeric"
                };
            ...
            GetVisibleSpecialEvents()
            {
                return [{
                    ...
                    startVisible: new Date(1e3 * Ae()("2020-06-16T14:00:00-07:00").unix()),
                    endVisible: new Date(1e3 * Ae()("2020-06-22T10:00:00-07:00").unix()),
                    startEvent: new Date(1e3 * Ae()("2020-06-16T10:00:00-07:00").unix()),
                    endEvent: new Date(1e3 * Ae()("2020-06-22T10:00:00-07:00").unix()),
        ...
        class He extends r.Component {
            render()
            {
                ...
                return r.createElement($.N_, {
                    to: "/" + e.newshubUrl
                }, r.createElement("div", {
                    className: (0, N.A)(ke().SpecialEvent, t && ke().SpecialEventOnPage, n && ke().SpecialEventActive)
                }, r.createElement("div", {
                    className: ke().SpecialEventTitle
                }, (0, T.we)(e.sLocToken)), a && r.createElement("div", {
        ...
        class Me extends r.Component {
            render()
            {
                ...
                }, (0, T.we)("#Events_SpecialEvents")), r.createElement("div", {
                    className: ke().SpecialEventList
                }, e.map((e => r.createElement(He, {
                    key: e.sLocToken,
                    specialEvent: e
                })))))
            }
        ...
        const Ue = e => {
                ...
                }, `© ${Pe()} Valve Corporation 版权所有，完美世界已获授权`, r.createElement("br", null), "所有商标均属于其在美国或其他国家的拥有者。"), r.createElement("div", {
                    className: Oe().mainmenu_legal_pwlegal
                }, "© 完美世界征奇(上海)多媒体科技有限公司 版权所有。", r.createElement("br", null), "增值电信业务经营许可证沪B2-20180406")))
            },
            Ve = e => r.createElement("div", {
                className: Oe().LegalFooter
            }, r.createElement("img", {
                src: D.TS.STORE_CDN_URL + "public/images/footerLogo_valve_new.png"
            }), r.createElement("div", {
                className: Oe().FooterLegal
            }, (0, T.we)("#Legal_Footer_WithYear", Pe()))),
            We = e => (0, D.Y2)() ? r.createElement(Ue, null) : r.createElement(Ve, null);
        class qe {
            ...
            static Get()
            {
                return qe.s_GlobalStore || (qe.s_GlobalStore = new qe), qe.s_GlobalStore
            }
            constructor()
            {
                (0, P.Gn)(this)
            ...
            UpdateLocation(e, t)
            {
                ...
                if (n)
                    ...
                    "desktop_navigation" != this.m_curDisplay && (this.m_curDisplay = "desktop_navigation");
                return this.m_curDisplay
            }
            SetDisplay(e)
            {
                this.m_curDisplay = e,
                this.m_fnGetRouterHistory && (0, s.Bm)(this.m_fnGetRouterHistory(), "optionpane", "desktop_navigation" == this.m_curDisplay ? void 0 : this.m_curDisplay)
            }
            GetDisplay()
            {
                return this.m_curDisplay
            ...
            ShowBrowseCurator(e)
            {
                Cn() ? qe.Get().SetDisplay("browse_curator") : (0, ie.pg)(r.createElement(Ie, null), (0, le.uX)(e))
            }
        }
        ...
        let Ye = class  extends r.Component{
            ...
            RenderEventTypeCheckbox(e)
            {
                ...
                return r.createElement(ae.he, {
                    key: `group-${e}`,
                    toolTipContent: (0, T.we)("#EventCalendar_EventTypeGroup_ttip_" + e),
                    direction: "top"
                }, r.createElement(Ze, {
            ...
            {
                const n = this.GetVisibilityStore().BIsGameSourceAllowed(e) || e == j.FD.k_ELibrary && this.GetVisibilityStore().BIsGameSourceAllowed(j.FD.k_ERecent);
                return r.createElement(ae.he, {
                    key: `gs-${e}`,
                    direction: "top",
                    toolTipContent: t ? (0, T.we)("#EventCalendar_DisabledFilter_LoginPrompt") : (0, T.we)("#EventCalendar_GameSource_ttip_" + e)
                }, r.createElement(Ze, {
            ...
            render()
            {
                ...
                if (t.BIsSingleGroupCalendar()) {
                    ...
                    !t.BIsCollectionCalendar() || t.GetKey().collectionid != z.g.Press && t.GetKey().collectionid != z.g.Dev_Sales && t.GetKey().collectionid != z.g.Dev_AssociatedPress || (n = !1);
                const a = function(e) {
                        return e.BIsCollectionCalendar() && "steam" === e.GetCollectionID()
                    }(t),
                    o = Q.S.Get().GetMutedSourceCount(),
                    l = t.BIsSingleSourceMuted() || !t.BIsSingleSourceCalendar() && o > 0;
                return r.createElement($e, {
                    title: (0, T.we)("#EventCalendar_FiltersTitle"),
                    description: (0, T.we)(t.BIsGlobalCalendar() ? "#EventCalendar_FiltersDescription" : "#EventCalendar_FiltersDescription_NonPersonalized")
                }, r.createElement("div", {
                    className: ke().FilterSection
                }, n && r.createElement(Ke, null, r.createElement(je, null, (0, T.we)("#EventCalendar_FilterSubSection_EventTypeGroups")), this.RenderEventTypeCheckbox(j.xj.k_EEvents), this.RenderEventTypeCheckbox(j.xj.k_EStreaming), this.RenderEventTypeCheckbox(j.xj.k_EUpdates), this.RenderEventTypeCheckbox(j.xj.k_EReleases), this.RenderEventTypeCheckbox(j.xj.k_ESales), this.RenderEventTypeCheckbox(j.xj.k_ENews)), Boolean(t.BIsGlobalCalendar()) && r.createElement(Ke, null, r.createElement(je, null, (0, T.we)("#EventCalendar_FilterSubSection_GameSources")), this.RenderGameSourceCheckbox(j.FD.k_ELibrary, !e), r.createElement("div", {
                    className: ke().FilterSubOption
                }, this.RenderGameSourceCheckbox(j.FD.k_ERecent, !e)), this.RenderGameSourceCheckbox(j.FD.k_EWishlist, !e), J.HD.bIsFollowingEnabled && this.RenderGameSourceCheckbox(j.FD.k_EFollowing, !e), this.RenderGameSourceCheckbox(j.FD.k_ERecommended, !e), this.RenderGameSourceCheckbox(j.FD.k_ESteam), J.HD.bIncludeFeaturedAsGameSource && this.RenderGameSourceCheckbox(j.FD.k_EFeatured)), Boolean(J.HD.bIsCuratorsEnabled && (t.BIsGlobalCalendar() || t.BIsSingleAppCalendar())) && r.createElement(Ke, null, r.createElement(je, null, (0, T.we)("#EventCalendar_FilterSubSection_CuratorSources")), this.RenderGameSourceCheckbox(j.FD.k_ECurator, !e), r.createElement(ze, {
                    onClick: qe.Get().ShowBrowseCurator
                }, (0, T.we)("#EventCalendar_BrowseCurators"))), a && r.createElement(Je, {
                    calendar: t,
                    onFilterChange: this.props.fnOnFilterChange
                }), Boolean(t.BIsSingleSourceMuted()) && r.createElement("div", null, (0, T.we)(t.BIsSingleGroupCalendar() ? "#EventCalendar_SingleGroupIsMuted" : "#EventCalendar_SingleAppIsMuted"))), r.createElement("div", {
                    className: ke().SideBarFilterNavLinks
                }, l && r.createElement(re.uU, {
                    className: ke().MutedSourcesGroup,
                    href: D.TS.STORE_BASE_URL + "account/emailoptout/app",
                    bDisableContextMenu: !0
                }, r.createElement(ze, null, r.createElement(ne.fSs, {
                    muted: !0
                }), (0, T.we)("#EventCalendar_ManageMutedSources"), r.createElement("div", {
                    className: ke().NumberDisplay
                }, o))), r.createElement(re.uU, {
                    href: D.TS.STORE_BASE_URL + "account/preferences",
                    bDisableContextMenu: !0
                }, r.createElement(ze, null, r.createElement(ne.nkJ, null), (0, T.we)("#EventCalendar_ManageStorePref")))))
            }
        }
        ;
        Ye = (0, O.Cg)([u.PA], Ye);
        ...
        function Je(e) {
            const {calendar: t, onFilterChange: n} = e,
                [a, o] = (0, U.q3)((() => [t.GetAllClans().filter((e=>p.ac.GetClanInfoByClanAccountID(e)?.group_name)), t.GetAllApps().filter((e=>L.A.Get().GetApp(e)?.GetName()))]));
            return (0, oe.wT)(t.BIsCollectionCalendar, "Attempted to render collection source filters for a non collection calendar"), t.BIsCollectionCalendar() ? r.createElement(Ke, null, r.createElement(je, null, (0, T.we)("#EventCalendar_FilterSubSection_CollectionSources")), a.map((e => r.createElement(Xe, {
                calendar: t,
                clanid: e,
                key: e,
                onFilterChange: n
            }))), o.map((e => r.createElement(Qe, {
                calendar: t,
                appid: e,
                key: e,
                onFilterChange: n
        ...
        function Xe(e) {
            ...
            return r.createElement(Ze, {
                ...
                checked: o,
                onChange: e => {
                    t.m_visibilityStore.SetClanVisibility(n, e),
                    a()
                }
            })
        }
        function Qe(e) {
            ...
            return r.createElement(Ze, {
                ...
                checked: o,
                onChange: e => {
                    t.m_visibilityStore.SetAppVisibility(n, e),
                    a()
                }
            })
        }
        function Ze(e) {
            ...
            }, r.createElement(te.Yh, {
                ...e
            }))
        }
        const $e = e => r.createElement("div", {
            className: ke().FilterControlPage
        }, r.createElement("div", {
            className: ke().FiltersTitle
        }, e.title), Boolean(e.description) && r.createElement("div", {
        ...
        let et = class  extends r.Component{
            ...
            render()
            {
                const {bUserIsLoggedIn: e, nDisappearingHeaderVisibleHeight: t, bIsCollapsed: n, fnToggleCollapsed: a, fnOnFilterChange: o} = this.props,
                    l = Cn(),
                    s = r.createElement("div", {
                        className: ke().MobileCloseButton,
                        onClick: () => {
                            this.OpenFilterSettings(!1),
                            a()
                        }
                    }, r.createElement(ne.i6V, null)),
                    i = n ? Math.max(0, t) : 0,
                    c = l ? null : r.createElement("div", {
                        onClick: a,
                    ...
                    }, r.createElement(ne.F2T, {
                        angle: n ? 180 : 0
                    }))),
                    u = l ? null : r.createElement("div", {
                ...
                return r.createElement(r.Fragment, null, r.createElement("div", {
                    className: (0, N.A)(ke().SidebarContainer, n && ke().SidebarCollapsed),
                    style: m
        ...
        const tt = (0, u.PA)((e => {
            const {bShouldIncludeLegalFooter: t, bShowUpcoming: n} = e,
                a = "Responsive_RequestMobileView" in window && window.Responsive_RequestMobileView;
            return r.createElement(r.Fragment, null, r.createElement("div", {
                className: ke().SidebarBackground
            }, r.createElement(ne.Qte, null)), r.createElement("div", {
                className: ke().SidebarTitle
            }, (0, T.PP)("#EventCalendar_Title", r.createElement("br", null))), r.createElement(ut, {
                bIsUpcoming: n
            }), r.createElement(Me, null), r.createElement("div", {
            ...
            }, r.createElement(ne.wB_, null), (0, T.we)("#EventCalendar_EditFilters"))), a && r.createElement("div", {
                className: (0, N.A)(ke().SidebarLink, ke().ForceResponsiveLink),
                onClick: a
            }, (0, T.we)("#EventCalendar_ShowResponsiveView")), t && r.createElement(We, null))
        }));
        let nt = class  extends r.Component{
            DecorateSearchSuggestion(e, t)
            {
                if (e && e.id) {
                    let n = "";
                    return "curators" == e.corpus ? n = "group/" + e.id : "games" == e.corpus && ((0, oe.wT)((0, ee.f)(e.type), "Unexpected app type " + e.type), n = "app/" + e.id), r.createElement($.N_, {
                        key: `suggestion-${e.id}`,
                        to: `/${(0, E.LJ)()}/${n}/`
                    }, t)
                }
        ...
        function at(e, t) {
            const n = (0, z.d)(e);
            if ((0, oe.wT)(!!n, "Must define collection " + e), !n)
                return null;
            let a,
            ...
            case z.g.Upcoming:
                r = (0, K.v0)().BIsGlobalCalendar() && t,
                a = function() {
                    if (!(0, K.v0)().BIsGlobalCalendar())
                        return;
                    if (!D.iA.logged_in)
                        return;
                    const e = (0, K.v0)().GetStoreInitializationTimestamp().getTime() / 1e3,
                        t = (0, K.v0)().GetCurrentlyLoadedEventCount(e);
                    if (!t)
                        return;
                    return (0, K.v0)().BHitEventHorizon("forward") ? String(t.nCount) : t.nCount + "+"
                }()
            }
            return {
                name: n.strName,
        ...
        function ot(e, t) {
            const n = new Array;
            return n.push(at(z.g.Featured, e)), n.push(at(z.g.Steam, e)), J.HD.GetTimeNowWithOverride() < 1668160800 && n.push(at(z.g.Halloween, e)), n
        }
        function lt(e, t) {
            (0, K.v0)().BIsCollectionCalendar(),
            (0, E.LJ)();
            const n = new Array;
            ...
            return D.iA.is_support && (n.push(at(z.g.Dev_All, e)), n.push(at(z.g.Dev_Sales, e)), n.push(at(z.g.Dev_AssociatedPress, e))), n
        }
        const st = e => {
            const {shortName: t, name: n, url: a, onPage: o, count: l, bValveOnly: s} = e.element;
            return !D.iA.is_support && s ? null : r.createElement($.N_, {
                to: "/" + a
            }, r.createElement("div", {
                className: (0, N.A)(ke().MobileNavButton, o && ke().MobileNavButtonActive)
        ...
        let it = class  extends r.Component{
            ...
            render()
            {
                const {bSearchExpanded: e} = this.state,
                    t = [...rt(this.props.bIsUpcoming), ...ot(this.props.bIsUpcoming), ...lt(this.props.bIsUpcoming, !1)];
                return r.createElement("div", {
                    style: {
                ...
                }, r.createElement(ne.wB_, null)), r.createElement("div", {
                    className: (0, N.A)(ke().SettingsPanel, e && ke().SearchExpanded),
                    onClick: () => this.onExpandSearch(!e)
                }, r.createElement(ne.eSy, null)), e && r.createElement(r.Fragment, null, r.createElement("div", {
                    className: ke().SearchDismiss,
                    onClick: () => this.onExpandSearch(!1)
                }), r.createElement("div", {
                    className: (0, N.A)(ke().SearchBox, e && ke().SearchExpanded)
                }, r.createElement(nt, {
                    focusOnMount: !0
        ...
        it = (0, O.Cg)([u.PA], it);
        const ct = e => {
            const {key: t, name: n, subtitle: a, url: o, onPage: l, count: s, bValveOnly: i, icon: c} = e.element;
            return !D.iA.is_support && i ? null : r.createElement($.N_, {
                to: "/" + o
            }, r.createElement("div", {
                className: (0, N.A)(ke().NewsChannel, l && ke().NewsChannelOnPage, i && b().ValveOnlyBackground)
            }, Boolean(c) && r.createElement("img", {
            ...
            }, i && "(VO) ", n), a && r.createElement("div", {
                className: ke().NewsChannelSubtitle
            }, a)), Boolean(void 0 !== s) && r.createElement("div", {
        ...
        let ut = class  extends r.Component{
            render()
            {
                ...
                }, (0, T.we)("#EventCalendar_NewsChannels")), r.createElement("div", {
                    className: ke().NewsChannelList
                }, e.map((e => r.createElement(ct, {
                    key: e.key,
                    element: e
                })))), r.createElement("div", {
                    className: ke().NewsChannelListTitle
                }, (0, T.we)("#EventCalendar_NewsChannels_Global")), r.createElement("div", {
                    className: ke().NewsChannelList
                }, t.map((e => r.createElement(ct, {
                    key: e.key,
                    element: e
                })))))
            }
        ...
        class dt extends r.Component {
            render()
            {
                ...
                return e && e.length > 0 ? r.createElement("div", {
                    className: (0, N.A)(ke().NewsChannelGroup, ke().DiscoverGroup)
                }, r.createElement("div", {
                    className: ke().NewsChannelListTitle
                }, (0, T.we)("#EventCalendar_NewsChannels_Discover")), r.createElement("div", {
                    className: ke().NewsChannelList
                }, e.map((e => r.createElement(ct, {
                    key: e.key,
                    element: e
        ...
        let St = class  extends r.Component{
            ...
            HideAllEventsOfMyType()
            {
                const {eventModel: e} = this.props,
                    t = this.GetVisibilityStore().MapClanEventTypeToGroup(e.GetEventType());
            ...
            {
                this.GetVisibilityStore().BIsGameSourceAllowed(t) && (a && e.push(r.createElement(vt.kt, {
                    key: `item-source-${n}-${t}`,
                    disabled: !0,
                    onSelected: () => {}
                }, (0, T.we)("#EventCalender_Reason_" + t))), e.push(r.createElement(vt.kt, {
            ...
            GotoGameOrClanHub()
            {
                ...
                t.startsWith("http") ? window.location.href = t : this.props.history.push(t)
            }
            ToggleFollowCurator()
            {
            ...
            CreateContextMenu(e)
            {
                ...
                const o = n.GetSource(),
                    ...
                    s = (0, D.Y2)(),
                    i = (0, K.v0)();
                if (i.BIsGlobalCalendar() && (o && o & W.bK.k_eLibrary && (this.GetVisibilityStore().BIsGameSourceAllowed(j.FD.k_ERecent) && n.appInfo ? (a.push(r.createElement(vt.kt, {
                    key: `item-source-${l}-lastplayed`,
                    disabled: !0,
                    onSelected: () => {}
                }, (0, T.we)("#EventCalender_LastPlayed", (0, T.Hq)(J.HD.GetTimeNowWithOverride() - n.appInfo.last_played)))), this.AddContextMenuForSource(a, j.FD.k_ERecent, l, !1)) : this.AddContextMenuForSource(a, j.FD.k_ELibrary, l)), o && o & W.bK.k_eWishlist && this.AddContextMenuForSource(a, j.FD.k_EWishlist, l), o && o & W.bK.k_eFollowing && this.AddContextMenuForSource(a, j.FD.k_EFollowing, l), !s && o && o & W.bK.k_eCurator && this.AddContextMenuForSource(a, j.FD.k_ECurator, l), o && o & W.bK.k_eRecommended && this.AddContextMenuForSource(a, j.FD.k_ERecommended, l), o && o & W.bK.k_eSteam && this.AddContextMenuForSource(a, j.FD.k_ESteam, l), o && o & W.bK.k_eFeatured && this.AddContextMenuForSource(a, j.FD.k_EFeatured, l)), a.push(r.createElement(vt.kt, {
                    key: t.GID + "hidetype",
                    onSelected: this.HideAllEventsOfMyType
                }, (0, T.we)("#EVentCalendar_Hide_EventType", (0, T.we)("#EventCalendar_EventTypeGroup_" + this.GetVisibilityStore().MapClanEventTypeToGroup(t.GetEventType()))))), D.iA.logged_in && (Q.S.Get().BIsEventBlocked(n) ? a.push(r.createElement(vt.kt, {
                    key: t.GID + "unmuteapp",
                    onSelected: this.OnUnMuteButton
                }, r.createElement(ae.he, {
                    toolTipContent: (0, T.we)("#EventCalendar_UnMuteApp_ttip")
                }, (0, T.we)("#EventCalendar_UnMuteApp_Title", this.props.calendarEvent.GetEntityName())))) : a.push(r.createElement(vt.kt, {
                    key: t.GID + "muteapp",
                    onSelected: this.OnMuteButton
                }, r.createElement(ae.he, {
                    toolTipContent: (0, T.we)("#EventCalendar_MuteApp_ttip")
                }, (0, T.we)("#EventCalendar_MuteApp_Title", this.props.calendarEvent.GetEntityName()))))), !t.BIsOGGEvent() && !s) {
                    const e = ce.Fm.Get().BIsFollowingCurator(t.clanSteamID);
                    a.push(r.createElement(vt.kt, {
                        key: t.GID + "followcurator",
                        onSelected: this.ToggleFollowCurator
                    }, r.createElement(ae.he, {
                        toolTipContent: (0, T.we)(e ? "#EventCalendar_UnFollowCurator_ttip" : "#EventCalendar_FollowCurator_ttip")
                    }, (0, T.we)(e ? "#EventCalendar_UnFollowCurator" : "#EventCalendar_FollowCurator", this.props.calendarEvent.GetEntityName()))))
                }
                i.BIsSingleSourceCalendar() || a.push(r.createElement(vt.kt, {
                    key: t.GID + "goto",
                    onSelected: this.GotoGameOrClanHub
                }, (0, T.we)("#EventCalendar_Goto_SpecificCalendar", n.GetEntityName()))),
                t.appid && a.push(r.createElement(vt.kt, {
                    key: t.GID + "goto",
                    onSelected: () => window.location.href = (0, ht.k2)(D.TS.STORE_BASE_URL + "app/" + t.appid)
        ...
        var ft = n(74976),
            ...
            Gt = n(27543);
        function Dt(e) {
            const {eventModel: t, calendarEvent: n, bSuppressHoverEffects: a, mode: o, bHideGameTitle: s, fnOnClicked: i} = e,
                [c, u] = r.useState(!1);
            r.useEffect((() => {
                if (n.clanInfo) {
            ...
            const m = X.KN.Get(),
                ...
                _ = "capsule",
                [v, h, C, S, w, f, I, b, y, T, G] = (0, U.q3)((() => [t.has_live_stream, t.GetEventType(), t.GetAllTags(), t.GetCategoryAsString(), t.GetNameWithFallback(g), t.BImageNeedScreenshotFallback(_, g), t.appid, t.GID, t.GetStartTimeAndDateUnixSeconds(), t.GetSubTitleWithLanguageFallback(g), t.GetSummaryWithFallback(g)])),
                [k, B] = r.useState((() => (0, yt.c5)() && 14 == h ? Y.wI.full : Y.wI.capsule_main)),
                A = (0, U.q3)((() => Boolean(f && I) ? t.GetFallbackArtworkScreenshot() : t.GetImageURLWithFallback(_, g, k))),
                L = "upcoming" !== o && function(e, t, n, a) {
                    ...
                    if ("youtube" === o) {
                        ...
                        const u = () => {
                            pt.V.RecordAppInteractionEvent(i, pt.E.k_ePlayedVideo),
                            n(!0)
                        };
                ...
                F = Ct()[`EventType${h}`],
                H = C.map((e => Ct()[`Tag-${e}`])),
                M = (0, N.A)(Ct().TileContainer, F, v && Ct().TileVideoIcon, a ? Ct().DisableHovers : Ct().EnableHovers, c && Ct().VideoPlayerReady, L && Ct().HasVideo, m.HasEventBeenRead(b) && Ct().HasBeenRead, "wide" === o && Ct().WideMode, "carousel" === o && Ct().CarouselMode, "upcoming" === o && Ct().UpcomingMode, ...H);
            let R = T,
                x = G;
            R === x && (x = void 0),
            R === w && (R = void 0);
            const O = (0, q.j3)(A),
                ...
                K = !V && P,
                j = "wide" !== o || a,
                z = 28 !== h && 12 !== h && J.HD.GetTimeNowWithOverride() < y && r.createElement("div", {
            ...
            }, 14 === h && r.createElement("div", {
                className: (0, N.A)(Ct().TileBackgroundImage, f && Ct().FallbackImage),
                style: {
            ...
            }, Boolean(12 == h) && r.createElement("div", {
                className: Ct().PatchIconCtn
            }, r.createElement(ne.vjL, null)), r.createElement("div", {
                className: Ct().EventTitleCtn
            }, W, !s && r.createElement("div", {
                className: Ct().GameSource
            }, r.createElement(At, {
                ...e
            }), n && r.createElement(Ft, {
                calendarEvent: n
            })), r.createElement("div", {
                className: Ct().EventName
            }, w), r.createElement("div", {
                className: Ct().EventTypeAndDateCtn
            }, r.createElement("div", {
                className: (0, N.A)(Ct().TileTextCategoryType, F)
            }, S), r.createElement(Lt, {
                eventModel: t,
                className: (0, N.A)(j && Ct().LeaveRoomForReminder)
            }), j && z), Z && r.createElement("div", {
                className: Ct().EventSubTitle
            }, R), Q && r.createElement("div", {
                className: (0, N.A)(Ct().EventSummaryDefault, R ? Ct().SubTitleShown : "")
            }, x)), !j && z), K))), r.createElement(Mt, {
                ...e
            }))
        }
        function kt(e) {
            const {videoPreview: t, eventModel: n, calendarEvent: a, mode: o, artworkType: l, strCapsuleImgURLForBackground: s, fnSetCoverSize: i} = e,
                c = (0, d.sf)(D.TS.LANGUAGE),
                u = !t && "upcoming" !== o,
                [m, g, _, v, h, E] = (0, U.q3)((() => [n.GetEventType(), n.has_live_stream, n.has_live_stream, n.clanSteamID.GetAccountID(), a.GetGameCapsule(), n.BImageNeedScreenshotFallback(l, c)]));
            r.useEffect((() => {
                const e = new Image;
                e.src = s,
                e.onerror = () => {
            ...
            return n.GetSubTitleWithLanguageFallback(c) === w && (w = void 0), r.createElement("div", {
                className: Ct().CoverImageCtn
            }, t, u && r.createElement(r.Fragment, null, 12 === m && r.createElement(r.Fragment, null, r.createElement("div", {
            ...
            }, (0, T.we)("#home_page_live_broadcast")), _ && r.createElement("div", {
                className: "VideoHintText"
        ...
        let Bt = class  extends r.Component{
            OnTitleClick(e)
            {
                ...
                n.startsWith("http") ? window.location.href = n : this.props.history.push(n),
                e.stopPropagation(),
                e.preventDefault()
            }
            render()
            {
                const {eventModel: e, calendarEvent: t, bSuppressHoverEffects: n} = this.props,
                    a = t.GetEntityName(),
                    o = t.GetGameIcon(),
                    l = (0, N.A)(Ct().GameTitleContainer, n ? Ct().DisableHovers : Ct().EnableHovers);
                return r.createElement(_.tH, null, r.createElement("div", {
                    className: Ct().TileTextHeader
                }, r.createElement("div", {
                    className: l,
                    onClick: this.OnTitleClick
                }, r.createElement("img", {
                    className: Ct().AppIcon,
                    src: o
                }), r.createElement("div", {
        ...
        const At = (0, o.y)(Bt),
            Lt = (0, u.PA)((e => {
                ...
                if (s && l < o && o < s) {
                    ...
                    }, r.createElement(bt.gS, {
                        rtFullDate: l,
                        stylesmodule: Ct()
                    }, r.createElement("div", {
                        className: Ct().LiveNow
                    }, (0, T.we)("#EventCalendar_LiveNow"))), r.createElement(bt.gS, {
                        rtFullDate: s,
                        stylesmodule: Ct()
                ...
                if (l < o) {
                    ...
                    return r.createElement(bt.gS, {
                        className: a,
                        rtFullDate: l,
                        stylesmodule: Ct()
                    }, r.createElement("div", {
                        className: Ct().PastDateText
                    }, t))
                }
                {
            ...
            Ft = (0, u.PA)((e => {
                ...
                t & W.bK.k_eLibrary && a.BIsGameSourceAllowed(j.FD.k_ELibrary) ? n.push({
                    id: W.bK.k_eLibrary,
                ...
                }) : t & W.bK.k_eWishlist && a.BIsGameSourceAllowed(j.FD.k_EWishlist) ? n.push({
                    id: W.bK.k_eWishlist,
                ...
                }) : t & W.bK.k_eRecommended && a.BIsGameSourceAllowed(j.FD.k_ERecommended) ? n.push({
                ...
                }) : t & W.bK.k_eFeatured && a.BIsGameSourceAllowed(j.FD.k_EFeatured) && n.push({
                    id: W.bK.k_eFeatured,
                    name: "#EventCalendar_GameSource_featured",
                    ttip: "#EventCalendar_GameSource_ttip_featured",
                    styles: Ct().FeaturedSource
                }),
                t & W.bK.k_eFollowing && a.BIsGameSourceAllowed(j.FD.k_EFollowing) && n.push({
                ...
                const o = n.map(((t, a) => {
                    ...
                    return Ht(`item-source-${r}-${t.id}`, t.name, t.ttip, t.styles, a + 1 < n.length)
                }));
                return r.createElement("div", {
                    className: Ct().SourceList
                }, o)
            })),
            Ht = (e, t, n, a, o) => r.createElement(ae.he, {
                key: e,
        ...
        let Mt = class  extends r.Component{
            OnPerformVoteUp()
            {
                const {eventModel: e} = this.props,
                    t = X.KN.Get();
                !0 !== t.GetPreviouslyLoadedVote(this.props.eventModel) && (0, gt.W)(e, t) && (t.Vote(e, !0, c().CancelToken.source()), pt.V.RecordAppInteractionEvent(e.appid, pt.E.k_eThumbsUp))
            }
            OnDiscussionClicked()
            {
                const {eventModel: e} = this.props;
            ...
            render()
            {
                const e = X.KN.Get(),
                    ...
                    o = function(e, t) {
                        return e.BIsUserLoggedIn() ? D.iA.is_limited ? Ct().Vote_LimitedUser : !0 === t ? Ct().Vote_Positive : !1 === t ? Ct().Vote_Negative : Ct().Vote_Ready : Ct().Vote_NotLoggedIn
                    }(e, a),
                    l = t.GetForumTopicURL(),
                    s = !(0, D.Y2)() && l,
                    i = t.live_stream_viewer_count > 0 ? t.live_stream_viewer_count : void 0;
                return r.createElement("div", {
                    className: Ct().Footer
                }, r.createElement("div", {
                    className: Ct().FooterRightSide
                }, Boolean(i) && r.createElement("div", {
                    className: Ct().TileViewerCount
                }, (0, Tt.Dq)(i)), r.createElement("div", {
                    className: (0, N.A)(Ct().FooterStat, Ct().Vote, o),
                    onClick: this.OnPerformVoteUp
                }, r.createElement(ne.bfp, {
                    className: Ct().RateIcon
                }), r.createElement("span", null, Number(n).toLocaleString())), s && r.createElement("div", {
                ...
                }, r.createElement(ne._h6, {
                    className: Ct().CommentIcon
                }), r.createElement("span", null, Number(t.nCommentCount).toLocaleString()))), r.createElement(wt, {
                    ...this.props
                })))
            }
        }
        ...
        const xt = (0, u.PA)((e => {
                const {calendarEvent: t, partnerEventStore: n, mode: a, forceParentUpdate: o} = e,
                    l = "-500px",
                    s = Ct()[`EventType${t.event_type}`],
                    i = (0, N.A)(Ct().TileContainer, s),
                    c = "carousel" === a;
                return r.createElement(mt.Y, {
                    onEnter: () => {
                        !function(e, t, n) {
                            const a = Array();
                            a.push(t.QueueLoadPartnerEvent(e.clanid, e.unique_id)),
                            e.appid && a.push(L.A.Get().QueueAppRequest(e.appid, Rt)),
                            e.clanInfo && a.push(p.ac.LoadClanInfoForClanAccountID(e.clanInfo.clanid)),
                            Promise.all(a).then((() => {
                                const a = t.GetClanEventModel(e.unique_id);
                                a && a.appid && a.appid != e.appid && !L.A.Get().BHasApp(a.appid, Rt) ? L.A.Get().QueueAppRequest(a.appid, Rt).then(n) : n()
                            }))
                        }(t, n, o)
                    },
                    topOffset: l,
                ...
                }, c && r.createElement(y.t, null)), r.createElement("div", {
                    className: Ct().Footer
                })))
            })),
            Ot = (0, u.PA)((e => {
                const {partnerEventStore: t, calendarEvent: n, ...a} = e,
                    ...
                    l = function(e, t) {
                        ...
                        return !(!n || e.appid && !L.A.Get().BHasApp(e.appid, Rt) || n.appid && n.appid != e.appid && !L.A.Get().BHasApp(n.appid, Rt) || e.clanInfo && !p.ac.HasLoadedClanAccountID(e.clanInfo.clanid))
                    }(n, t),
                    s = (0, se.CH)();
                return l ? r.createElement(Dt, {
                    eventModel: o,
                    calendarEvent: n,
                    ...a
                }) : r.createElement(xt, {
        ...
        function Jt() {
            ...
            for (const n of e) {
                ...
                if (!e)
                    continue;
                const a = e.filter((e => !ce.Fm.Get().BIsIgnoringCurator(e.clanAccountID)));
                (0, Yt.fW)(a),
                t.push(...a)
            }
            return t
        ...
        function Xt(e) {
            const {bCanDismiss: t} = e,
                ...
                d = (0, r.useCallback)((() => {
                    if (!u.token.reason)
                        if (c.current) {
                            const e = 118,
                                t = Math.floor(Math.min(c.current.clientWidth, window.innerWidth) / e);
                            l(Math.max(t - 1, 0))
                        } else
                            l(0)
                }), [u.token.reason]);
            if ((0, r.useEffect)((() => d()), [d]), (0, r.useEffect)((() => {
                if (null == s) {
                    (async () => {
                        await ue.Get().WaitForInitialLoad(),
                        u.token.reason || i(Jt)
            ...
            }, (0, T.we)("#EventCurator_FeedCaption_Long")), t && r.createElement("div", {
                className: jt().DismissButton,
                onClick: e => {
                    (0, ie.pg)(r.createElement(Ee.o0, {
                        strTitle: (0, T.we)("#EventCurator_DismissTitle"),
                        strDescription: (0, T.we)("#EventCurator_DismissBody"),
                        onOK: () => {
            ...
            }, r.createElement(ne.i6V, null)), r.createElement("div", {
                className: jt().RowContainer,
                ref: c
            }, m || r.createElement(y.t, null), r.createElement("div", {
        ...
        var Qt = n(57688),
            Zt = n.n(Qt);
        const $t = e => {
            const {titleToken: t, subtitleToken: n, backgroundImg: a, headerImg: o, headerURL: l} = e,
                s = a ? {
                    backgroundImage: a
                } : {};
            return r.createElement("div", {
                className: (0, N.A)(Zt().CommonHeaderStyles, Zt().SimpleTitleHeaderCtn, e.largeHeader && Zt().LargeHeader),
                style: s
            }, r.createElement("div", {
                className: (0, N.A)(Zt().CollectionBannerGroup, o ? Zt().HeaderImg : Zt().NoHeaderImg)
            }, Boolean(l && o) && r.createElement("a", {
                href: l,
                className: Zt().AppBannerLogoCtn
            }, r.createElement("img", {
                className: Zt().AppBannerLogo,
                src: o
            })), Boolean(o && !l) && r.createElement("div", {
                className: Zt().AppBannerLogoCtn
            }, r.createElement("img", {
                className: Zt().AppBannerLogo,
                src: o
        ...
        let tn = null;
        function nn() {
            return tn || (tn = new Array, tn.push(en(z.g.Press)), tn.push(en(z.g.Halloween))), tn
        }
        var an,
            rn = n(1596),
            on = n(25738),
        ...
        let sn = class  extends r.Component{
            render()
            {
                const {rgCalendarItems: e, bSuppressHoverEffects: t, strMultipleSourceTitle: n} = this.props;
                if (!e || 0 == e.length)
                    return null;
                const a = e[0];
        ...
        let cn = an = class  extends r.Component{
            ...
            render()
            {
                const {rgCalendarItems: e, fnOnEventClick: t, bSuppressHoverEffects: n, bHideGameTitle: a, strMultipleSourceTitle: o} = this.props;
                if (!e || 0 == e.length)
                    return null;
                const l = e.map((o => r.createElement(Ot, {
                    key: "ht-" + o.unique_id,
                    calendarEvent: o,
                    partnerEventStore: Z.O3,
                    fnOnClicked: t,
                ...
                return r.createElement("div", {
                    ...
                    className: (0, N.A)(ln().EventTileCarousel, "EventTileCarouselCtn")
                }, r.createElement(rn.F, {
                    hideArrows: !0,
                    visibleElements: Math.min(this.state.nMaxCapsulesPerRow, this.props.rgCalendarItems.length),
        ...
        const mn = e => {
                let t = new Array;
                return D.TS.SUPPORTED_LANGUAGES?.length ? t = D.TS.SUPPORTED_LANGUAGES.map((e => e.localizedName)) : t.push((0, T.we)("#Language_" + D.TS.LANGUAGE)), r.createElement("div", {
            ...
            pn = e => {
                ...
                }, r.createElement(ne.vCk, null)), r.createElement("div", {
                    className: dn().RightColumn
                }, r.createElement("div", {
                    className: dn().Title
                }, (0, T.we)("#EventCalendar_NewsLanguage_Title")), r.createElement(mn, null), r.createElement("div", {
                    className: dn().Text
                }, (0, T.PP)("#EventCalendar_NewsLanguage_Text", r.createElement("a", {
                    href: o
                }, (0, T.we)("#EventCalendar_NewsLanguage_TextInHyperlink"))))))))
            };
        var gn,
            _n,
            vn = n(82477);
        ...
        function En() {
            ...
            if ((0, oe.wT)(t.length <= 1, "Must have at most one responsive_header"), 1 == t.length) {
                return t[0]
            }
            return null
        }
        ...
        function Sn() {
            return Cn() || window.innerWidth < parseInt(ke().strDesktopControlBarWidth) + parseInt(ke().strMaxMobileWidth)
        }
        let wn = class  extends r.Component{
            ...
            componentDidMount()
            {
                ...
                D.TS.IN_MOBILE_WEBVIEW && this.props.location && 0 == this.props.history.length && this.props.history.push(this.props.location)
            }
            componentDidUpdate(e, t)
            {
                t.bUserIsLoggedIn == this.state.bUserIsLoggedIn && JSON.stringify(e.filter_to_appids) == JSON.stringify(this.props.filter_to_appids) && JSON.stringify(e.filter_to_clanids) == JSON.stringify(this.props.filter_to_clanids) && e.filter_to_collection === this.props.filter_to_collection && e.filter_to_saleid === this.props.filter_to_saleid && e.filter_to_contenthub_hubtype === this.props.filter_to_contenthub_hubtype && e.filter_to_contenthub_category_or_language === this.props.filter_to_contenthub_category_or_language && e.filter_to_contenthub_tag_name === this.props.filter_to_contenthub_tag_name && e.section_by_day === this.props.section_by_day || (window.scrollTo(0, 0), this.InitEventCalendarStore()),
                this.UpdateDocumentUI(),
            ...
            UpdateEventControlLocationAndVisibility()
            {
                if (this.props.location) {
                    const e = qe.Get().UpdateLocation((() => this.props.history), this.props.location);
                    ("desktop_navigation" != e && this.state.bControlBarIsCollapsed || "desktop_navigation" == e && !this.state.bControlBarIsCollapsed && Cn()) && this.ToggleControlBarCollapsed()
                }
            }
            componentWillUnmount()
            {
            ...
            {
                const t = e && !(0, yt.c5)();
                return (0, K.v0)().GetCollectionID() ? function(e, t) {
                    if (!e)
                        return 0;
                    const n = nn().find((t => t.collection === e));
                    return n ? t ? n.largeHeight : n.smallHeight : 0
                }((0, K.v0)().GetCollectionID(), t) : (0, K.v0)().BIsSaleCalendar() ? (n = (0, K.v0)().GetSaleID(), a = t, n && Z.O3.GetClanEventModel(n) ? Number(a ? Zt().simpleTitleLargeHeight : Zt().simpleTitleSmallHeight) : 0) : (0, K.v0)().BIsSingleSourceCalendar() ? parseInt(t ? ke().strJumboHubBannerHeight : ke().strDesktopHubBannerHeight) - 1 : 0;
                var n,
                    a
            }
            BShowLogInBanner()
            {
                return Boolean(!this.state.bUserIsLoggedIn && (0, K.v0)().BIsGlobalCalendar())
            }
            GetCurrentHeaderHeights(e)
            {
                const t = Cn(),
                    n = (0, yt.c5)();
                let a = 0;
                En() && (a = parseInt(t ? ke().strMobileGlobalHeaderHeight : ke().strDesktopGlobalHeaderHeight), a -= 1);
                const r = parseInt(n ? ke().strMobileGroupHeaderHeight : ke().strDesktopGroupHeaderHeight) - 1,
                    o = (t ? parseInt(ke().strMobileNavBannerHeight) : 0) - 1,
                    l = this.GetCurrentHubBannerHeight(e);
                let s = 0;
                return this.BShowLogInBanner() && (s = e && !n ? parseInt(ke().strLogInBannerLargeHeight) : parseInt(ke().strLogInBannerSmallHeight)), {
            ...
            async LoadEventToShowAsModal()
            {
                ...
                if (!!e && "0" !== e && "false" !== e) {
                    ...
                    const e = {
                        ...
                        t = await Z.O3.LoadAdjacentPartnerEvents(null, null, q.DU, 0, 1, e);
                    if (1==t?.length) {
                        const e = t[0];
                ...
                if (!!t && "0" !== t && "false" !== t) {
                    ...
                    const [e, n] = "beta" === t ? [null, q.Ro] : [q.DU, null],
                        ...
                        r = await Z.O3.LoadAdjacentPartnerEvents(null, l.b.InitFromClanID(n), e, 0, 1, a);
                    if (1==r?.length) {
                        const e = r[0];
                        (0, s.iV)(this.props.history, {
                            emclan: e.clanSteamID.ConvertTo64BitString(),
                        ...
                        console.error("Could not find the most recent Steam client patch notes.")
                }
                const n = (0, s.f3)(this.props.location, "emclan"),
                    a = (0, s.f3)(this.props.location, "emgid");
                if (n && a) {
                    const e = new l.b(n);
                    if (this.state.modalEvent && this.state.modalEvent.clanSteamID.ConvertTo64BitString() == e.ConvertTo64BitString() && this.state.modalEvent.GID == a)
                        return;
                    const t = await Z.O3.LoadPartnerEventFromClanEventGIDAndClanSteamID(e, a, 0);
                    this.setState({
                        modalEvent: t
                    })
                } else
                    this.state.modalEvent && this.setState({
                        modalEvent: null
                    })
            }
            BShowFutureView()
            ...
            BShowUpdatesOnly()
            {
                return !(!this.props.filter_to_appids || 1 != this.props.filter_to_appids.length || "true" != (0, s.f3)(this.props.location, "updates"))
            }
            UpdateDocumentUI()
            {
                let e,
                ...
                if (n.BIsGlobalCalendar()) {
                    const t = (0, z.d)(this.BShowFutureView() ? z.g.Upcoming : z.g.Default);
                    ...
                    if (a) {
                        if (a.appid)
                            e=L.A.Get().GetApp(a.appid)?.GetName();
                        else {
                ...
                e && (a = t ? (0, T.we)("#EventCalendar_TabTitle_GroupNameAndEventDetail", e, t) : (0, T.we)("#EventCalendar_TabTitle_GroupHub", e)),
                document.title != a && (document.title = a),
                document.body.classList.contains("events_hub") || document.body.classList.add("events_hub")
            }
            OnResize()
            {
                this.setState((e => {
                    ...
                    return this.UpdateBodyScrollState(n), {
                        nVisibleHeight: t,
            ...
            async InitEventCalendarStore()
            {
                const e = {
                        ...
                        category_or_language: this.props.filter_to_contenthub_category_or_language,
                    ...
                    n = (0, K.v0)(),
                    a = (Q.S.Get(), Boolean(this.state.bUserIsLoggedIn && D.iA.accountid)),
                    r = n.BIsGlobalCalendar() && a ? "local" : "session",
                    o = n.BIsGlobalCalendar() ? "U" + D.iA.accountid : t;
                n.m_visibilityStore.Init(a, this.BShowUpdatesOnly(), n.BIsShowingFeaturedFeed(), o, r);
                const s = !n.BIsCollectionCalendar();
                if (n.SetFilteredView((e => n.m_visibilityStore.BShouldDisplayEvent(e)), s), gn.m_bInitialLoad) {
                    const e = (0, D.Tc)("metadatainfo", "application_config");
                    n.SetCollectionMetaData(n.ValidateCollectionMetadata(e) ? e : null)
                }
                const i = gn.m_bInitialLoad && (0, D.Tc)("initialEvents", "application_config");
                i ? (await n.RegisterCalendarEventsAndModels(i), gn.m_bInitialLoad = !1) : await n.RegisterCalendarEventsAndModels({
                    success: 1
                }),
                n.BIsSingleSourceCalendar() && (n.BIsSingleAppCalendar() ? L.A.Get().QueueAppRequest(n.GetSingleAppID(), {
                    include_assets: !0,
                    include_platforms: !0,
                    include_basic_info: !0,
                    include_release: !0
                }) : p.ac.LoadClanInfoForClanSteamID(l.b.InitFromClanID(n.GetSingleGroupID()))),
                this.OnResize()
            }
            UpdateBodyScrollState(e)
            {
                const t = !e && Cn(),
                    n = document.body;
                n && (t ? n.classList.add(ke().BodyNoScroll) : n.classList.remove(ke().BodyNoScroll))
            }
            MobileNavOpenSettings()
            {
                this.ToggleControlBarCollapsed(),
                this.m_refControlBar.current && this.m_refControlBar.current.OpenFilterSettings(!0)
            }
            ToggleControlBarCollapsed()
            {
                this.setState((e => {
                    const t = !e.bControlBarIsCollapsed,
                        ...
                        r = En();
                    return r && (r.style.transform = `translateY(${a}px)`), this.UpdateBodyScrollState(t), {
            ...
            {
                const e = En();
                e && (e.style.transform = `translateY(${this.state.nDisappearingHeaderTop}px)`),
                "PUSH" === this.props.history.action ? this.props.history.goBack() : (0, s.ip)(this.props.history, {
                    emclan: void 0,
                    emgid: void 0
                })
            }
            OnEventClicked(e)
            {
                ...
                const t = this.state.nSteamNavHeaderHeight + this.state.nHubBannerHeight + this.state.nMobileNavBannerHeight,
                    n = En();
                if (n && (n.style.transform = `translateY(${-1 * t}px)`), J.HD.bOpenEventLandingPage) {
            ...
            ToggleFutureView()
            {
                (0, s.Bm)(this.props.history, "upcoming", this.BShowFutureView() ? "false" : "true")
            }
            ResetAllFilters()
            {
                (0, s.Bm)(this.props.history, "updates", void 0),
                (0, K.v0)().m_visibilityStore.InitDefaultCheckboxes(this.state.bUserIsLoggedIn, !1)
            }
            render()
            {
                const e = this.state.nSteamNavHeaderHeight + this.state.nHubBannerHeight + this.state.nMobileNavBannerHeight + this.state.nLogInBannerHeight,
                    t = this.state.nDisappearingHeaderTop + this.state.nSteamNavHeaderHeight,
                    ...
                    l = o ? 0 : this.state.nDisappearingHeaderTop + this.state.nSteamNavHeaderHeight,
                    s = o ? 0 : this.state.nDisappearingHeaderTop + e,
                    i = (0, K.v0)().m_visibilityStore.BAreAnyEventsFiltered(this.state.bUserIsLoggedIn) ? this.ResetAllFilters : null;
                return r.createElement(r.Fragment, null, r.createElement("div", {
                    className: ke().EventCalendarContainer
                }, r.createElement(_.tH, null, this.state.modalEvent ? r.createElement(h.N, {
                ...
                }) : null), r.createElement(_.tH, null, r.createElement(et, {
                ...
                })), r.createElement(_.tH, null, r.createElement("div", {
                    className: (0, N.A)(ke().ReserveControlSpace, !this.state.bControlBarIsCollapsed && ke().WideLeftGutter)
                }, r.createElement(_.tH, null, this.state.nLogInBannerHeight > 0 && r.createElement(Bn, {
                    nTopOffset: n,
                    bLargeMode: this.state.nScrollTop <= 0 && !(0, yt.c5)()
                })), r.createElement(_.tH, null, this.state.nMobileNavBannerHeight > 0 && r.createElement(it, {
                    ...
                    nTopOffset: a,
                    bLargeMode: this.state.nScrollTop <= 0 && !(0, yt.c5)()
                })), r.createElement(_.tH, null, r.createElement(bn, {
                    ...
                    bUserIsLoggedIn: Boolean(this.state.bUserIsLoggedIn && D.iA.accountid)
                }))))))
            }
        }
        ;
        ...
        function In(e) {
            const t = (0, U.q3)((() => (0, K.v0)())),
                [n, a, o, s, i, c, u, m] = (0, U.q3)((() => [t.GetCollectionMetaData()?.clan_event_gid || void 0, t.GetCollectionID(), t.BHasCollectionMetaData(), t.BIsSaleCalendar(), t.GetSaleID(), t.BIsSingleSourceCalendar(), t.BIsSingleAppCalendar() ? t.GetSingleAppID() : void 0, t.BIsSingleGroupCalendar() ? t.GetSingleGroupID() : void 0])),
                [p, g] = r.useState(!1),
            ...
            if (r.useEffect((() => {
                if (o && n && !Z.O3.GetClanEventModel(n)) {
                    ...
                    (async () => {
                        ...
                        await Z.O3.LoadPartnerEventFromClanEventGIDAndClanSteamID(n, e.clan_event_gid, 0),
                        g(!1)
                    })()
                }
            }), [t, o, n]), a) {
                ...
                if (o && !p) {
                    ...
                    e && (t = e.GetImageURLWithFallback("capsule", _, Y.wI.capsule_main), l = e.GetSaleURL())
                }
                ...
                return r.createElement("div", {
                    style: {
                        transform: `translateY(${e.nTopOffset}px)`
                    },
                    className: i
                }, s)
            }
            if (s) {
                const t = function(e, t) {
                    ...
                    return r.createElement($t, {
                        ...
                        headerImg: n.GetImageURLWithFallback("capsule", a, Y.wI.capsule_main)
                    })
                }(i, e.bLargeMode);
                if (!t)
                    return null;
            ...
            if (c) {
                const t = (0, N.A)(ke().HubBanner, Vt().WideBanner, e.bLargeMode && ke().LargeMode, e.bLargeMode && Vt().TallBanner);
                return r.createElement("div", {
                    style: {
                        transform: `translateY(${e.nTopOffset}px)`
                    },
        ...
        let bn = class  extends r.Component{
            ...
            {
                let e = 0;
                return (0, K.v0)().GetCalendarSections(this.props.bShowFutureViewOnly).map((t => {
            ...
            GetMergeEventsType()
            {
                const e = (0, K.v0)(),
                    t = e.GetCollectionID();
                return e.BIsSingleSourceCalendar() || t === z.g.Steam ? "none" : e.BIsShowingFeaturedFeed() ? "full" : t ? "samesource" : "full"
            }
            ...
            {
                const e = (0, K.v0)(),
                    {bShowFutureViewOnly: t, bShowUpdatesOnly: n, fnOnEventClick: a, fnToggleSeeFuture: o, fnResetFilters: l, nScrollTop: s, nDisappearingHeaderVisibleHeight: i} = this.props,
                ...
                let _;
                const v = d ? [] : this.GetCurrentSectionLayout().map((({section: e, nTopOfSection: n}, l) => {
                    const {strId: s, strSectionLabel: i, rtSectionStart: c, rtSectionEnd: d, bIsFutureSection: v, nRenderedHeight: h} = e,
                        E = n < m,
                        C = (0, N.A)(ke().PastSection, p && ke().DarkerBackground);
                    h > 0 && (p = !p, void 0 !== g.nInlineOffset && n >= g.nInlineOffset && void 0 === _ && (_ = l));
                    const S = !t && v;
                    return r.createElement(Pt.K, {
                        key: s,
                ...
                void 0 !== _ && v.splice(_, 0, r.createElement(Xt, {
                    key: "CuratorSuggestions",
                    bCanDismiss: g.bInlineDismissable
                })),
                e.GetCollectionID() === z.g.Press && v.splice(0, 0, r.createElement(pn, {
                    key: "LanguageFeedRow"
                }));
                const h = c[0].rtSectionStart,
                    E = (0, K.v0)().GetCurrentlyLoadedEventCount(0, h),
                    C = (0, K.v0)().GetCurrentlyLoadedEventCount(h);
                let S = E && (E.nCount ? "#EventCalendar_NoMorePastEvents" : "#EventCalendar_NoPastEvents"),
                    w = l && r.createElement(ae.he, {
                        key: "link-back",
                ...
                d && this.props.fnResetFilters ? S = "#EventCalendar_EmptyCalendar" : t ? (S = C && (C.nCount ? "#EventCalendar_NoMoreFutureEvents" : "#EventCalendar_NoFutureEvents"), w = E && r.createElement("div", {
                    key: "link-back",
                    className: ke().BackToThePast,
                    onClick: o
                }, (0, T.we)("#EventCalendar_PastEventsLink"), r.createElement("span", {
                    className: ke().SeeAllCount
                }, E.nCount + (E.bIsComplete ? "" : "+")))) : n && (S = E && (E.nCount ? "#EventCalendar_NoMorePastUpdates" : "#EventCalendar_NoPastUpdates"));
                let f = null;
                return (d || e.BHitEventHorizon(t ? "forward" : "backward")) && (f = r.createElement(r.Fragment, null, r.createElement("div", {
                    key: "no-more-events",
                    className: (0, N.A)(ke().EndOfRows, ke().CalendarRow)
                }, r.createElement("div", {
                    className: ke().NoMoreRows
                }, " ", (0, T.we)(S), " ")), g.bShowAtEnd && r.createElement(Xt, {
                    key: "CuratorSuggestions",
                    bCanDismiss: !1
                }), w)), r.createElement("div", {
                ...
                }, (0, T.we)("#EventCalendar_UpdatesViewHeader")), v, f))
            }
        }
        ;
        bn = (0, O.Cg)([u.PA], bn);
        let yn = class  extends r.Component{
            render()
            {
                const e = this.props.rgCalendarItems[0].start_time,
                    t = (0, K.v0)().GetCurrentlyLoadedEventCount(e);
                return this.props.rgCalendarItems.length <= 1 ? null : r.createElement("div", {
                    key: "see-all-link",
                    className: ke().MobileSeeAllink,
                    onClick: this.props.fnOnSeeFutureClick
                }, (0, T.we)("#EventCalendar_FutureEventsLink"), r.createElement("span", {
                    className: ke().SeeAllCount
        ...
        let Nn = class  extends r.Component{
            render()
            {
                const {rgCalendarItems: e, fnOnEventClick: t, fnOnSeeFutureClick: n, bSuppressHoverEffects: a} = this.props;
                return e && 0 != e.length ? r.createElement("div", {
                    className: ke().CalendarRow
                }, r.createElement("div", {
                    className: (0, N.A)(ke().HorizontalTileContainer, "HorizontalTileCtn")
                }, r.createElement("div", {
                    className: ke().HorizontalTiles
                }, e.map((n => r.createElement(Ot, {
                    key: "ht-" + n.unique_id,
                    calendarEvent: n,
                    partnerEventStore: Z.O3,
                    fnOnClicked: t,
                    ...
                    bHideGameTitle: (0, K.v0)().BIsSingleSourceCalendar() && (0, K.v0)().BEventMatchCalendarSingleSource(n)
                })))), r.createElement(yn, {
                    rgCalendarItems: e,
        ...
        let Dn = _n = class  extends r.Component{
            ...
            {
                return (0, K.v0)().GetCalendarItemsInTimeRange((0, V.uP)((() => this.rtSectionStart)), (0, V.uP)((() => this.rtSectionEnd)))
            }
            GetCarouselGroupTitle(e)
            {
                return e.BIsShowingFeaturedFeed() ? (0, T.we)("#EventCalendar_GroupTitle_FeaturedCurators") : e.BIsGlobalCalendar() ? (0, T.we)("#EventCalendar_GroupTitle_Curators") : ""
            }
            GenerateKeyFromItem(e, t)
            {
                return t.GetSource() & W.bK.k_eSteam || t.appid || "full" !== e ? t.clanid : Gn.eCurators
            }
            ...
            RenderEventList(e)
            {
                const {fnOnEventClick: t, bSuppressHoverEffects: n, strMergeEvents: a} = this.props,
                    o = (0, K.v0)();
                let l = null;
                if ("none" !== a) {
                    l = new Map;
                ...
                let d = this.props.bShowEarliestFirst ? this.props.rtSectionStart : this.props.rtSectionEnd;
                for (const i of e) {
                    let e = s;
                    if (l) {
                        ...
                        if (s === Gn.eCurators && (e = c), u.length >= 3) {
                            const a = s === Gn.eCurators ? this.GetCarouselGroupTitle(o) : "",
                                c = !u.find((e => e.clanid != i.clanid));
                            u.sort(((e, t) => t.score != e.score ? t.score - e.score : t.start_time - e.start_time)),
                    ...
                    e === s && (this.AddTimestampEventsInInterval(u, Math.min(d, i.start_time), Math.max(d, i.start_time), s), d = i.start_time),
                    e.push(r.createElement("div", {
                        key: i.unique_id,
                        className: ke().CalendarRow
                    }, r.createElement(Ot, {
                        ...
                        fnOnClicked: t,
                        bSuppressHoverEffects: n,
                        bHideGameTitle: o.BIsSingleSourceCalendar() && o.BEventMatchCalendarSingleSource(i)
                    })))
                }
                return this.props.bShowEarliestFirst ? this.AddTimestampEventsInInterval(u, d, this.props.rtSectionEnd, s) : this.AddTimestampEventsInInterval(u, this.props.rtSectionStart, d, s), s.push(...i), s
            }
            render()
            {
                const {bRenderStickyHeader: e, strSectionLabel: t, strSectionClassname: n, bUseHorizontalLayout: a, fnOnSeeFutureClick: o, bShowEarliestFirst: l, fnOnEventClick: s, bSuppressHoverEffects: i} = this.props;
                ...
                let d = null;
                c.length > 0 && (d = r.createElement("div", {
                    className: (0, N.A)(ke().GroupHeader, ke().CalendarRow, e && ke().HeaderAtTop)
                }, r.createElement("div", {
                    className: ke().GroupHeaderTitle
                }, r.createElement("span", null, t), r.createElement("div", {
                    className: ke().GroupHeaderLine
                }), a && c.length > 3 && r.createElement("div", {
                ...
                let m = null;
                return (!J.HD.bRequireAllEventsLoadedInTimeBlock || u || a && c.length >= 3) && (m = a ? r.createElement(Nn, {
                    rgCalendarItems: c.slice(0, 3),
                    fnOnEventClick: s,
                    fnOnSeeFutureClick: o,
                    bSuppressHoverEffects: i
                }) : this.RenderEventList(c)), r.createElement("div", {
                    ref: this.m_ref,
                    className: n
                }, d, m, !u && !a && r.createElement(kn, {
        ...
        const kn = e => {
                const t = (0, K.v0)().GetTimeEdgeForDirection(e.bShowEarliestFirst ? "forward" : "backward", void 0);
                return r.createElement("div", {
                ...
                }, (0, T.we)("#EventCalendar_LoadEventsProgress", Number((0, K.v0)().GetNumEventsLoaded()).toLocaleString(), (0, T.lQ)(t))), r.createElement("div", {
                    className: ke().AdjustFiltersText
                }, (0, T.we)("#EventCalendar_LoadEventsFilters"))))
            },
            Bn = e => r.createElement("div", {
                className: (0, N.A)(ke().LogInFeedRow, !e.bLargeMode && ke().LogInSmallMode),
                style: {
                    transform: `translateY(${e.nTopOffset}px)`
                }
            }, r.createElement("div", {
            ...
            }, (0, T.we)("#EventCalendar_SignIn_Title")), r.createElement("button", {
                onClick: vn.vg,
                className: ke().LogInButton
            }, (0, T.we)("#Login_SignIn")), r.createElement("div", {
        ...
        const Mn = e => {
            const [t] = (0, s.QD)("byday", !1),
                [n] = (0, s.QD)("upcoming", !1);
            return (0, Ln.vb)(Fn.TS.LANGUAGE) ? r.createElement(An.d, {
                bSalePage: !0
            }, r.createElement(o.dO, null, r.createElement(o.qh, {
                exact: !0,
                path: a.B.EventViewByApp(":appid(\\d+)", ":event_gid(\\d+)", ":vanity?"),
                render: e => r.createElement(x, {
                    key: "detailview_" + e.match.params.event_gid,
                    ...e,
                    appid: e.match.params.appid && Number.parseInt(e.match.params.appid),
                    event_gid: e.match.params.event_gid,
                    bInfiniteScroll: "inline" == e.match.params.viewtype
                })
            }), r.createElement(o.qh, {
                exact: !0,
                path: a.B.EventViewByGroup(":groupid(\\d+)", ":event_gid(\\d+)", ":vanity?"),
                render: e => r.createElement(x, {
                    key: "detailview_" + e.match.params.event_gid,
                    ...e,
                ...
                exact: !0,
                path: a.B.OldAnnouncementViewByApp(":appid(\\d+)", ":announcement_gid(\\d+)", ":vanity?"),
                render: e => r.createElement(x, {
                ...
                exact: !0,
                path: a.B.OldAnnouncementViewByGroup(":groupid(\\d+)", ":announcement_gid(\\d+)", ":vanity?"),
                render: e => r.createElement(x, {
                    key: "detailoldview_" + e.match.params.announcement_gid,
                    ...e,
                    clansteamid: new l.b(e.match.params.groupid),
                ...
                exact: !0,
                path: a.B.NewsHubContentHub(":hubtype", ":category_or_language?", ":tag_name?"),
                render: e => r.createElement(fn, {
                    key: e.match.params.hubtype + "_" + e.match.params.category_or_language + "_" + e.match.params.tag_name,
                    ...e,
                    filter_to_contenthub_hubtype: e.match.params.hubtype,
                    filter_to_contenthub_category_or_language: e.match.params.category_or_language,
